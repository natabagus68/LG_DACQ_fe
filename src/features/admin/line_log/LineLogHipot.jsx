...
import HipotConfirmDelete from "./HipotConfirmDelete";

export const Line1HipotLogTable = ({ alert: _alert }) => {
    ...
    const { data: line1HipotLogs, isLoading: line1HipotLogsLoading } =
        useLine1HipotLogsQuery(qParams);
    useEffect(() => {
        ...
        <>
            ...
            <div className="px-[24px] pb-[18px] flex-1 flex flex-col justify-between">
                <Table>
                    ...
                    <tbody>
                        {line1HipotLogs?.data?.map((item, i) => {
                            return (
            ...
            <div className="flex bg-white h-full p-[26px] flex-col font-inter">
                <div className="text-[#A9A8A8] flex items-center justify-between mb-3">
                    <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm">/</span>
                        <Link
                            to={`${config.pathPrefix}lines/line-1/hipot`}
                            className="font-semibold text-sm"
                        >
                            Hipot
                        </Link>
                ...
                <div className="flex-1">
                    <div className="w-full h-full flex-col flex border-[1px] border-[#EAEAEA] rounded-lg">
                        ...
                        <Line1HipotLogTable alert={_alert} />
                    </div>
                </div>
            </div>
        </>

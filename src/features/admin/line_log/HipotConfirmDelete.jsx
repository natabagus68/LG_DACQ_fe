...
import { useLine1HipotDestroyMutation } from "../../../app/services/hipotService";
import { TrashIcon } from "../../../common/components/icons";

export default function HipotConfirmDelete({ hipotId }) {
    let [isOpen, setIsOpen] = useState(false);
    const [
        _destroyHipot,
        { isLoading: destroyHipotIsLoading, isError: destroyHipotIsError },
    ...
    function destroyHipot(e) {
        e.preventDefault();
        _destroyHipot(hipotId)?.then(success => {
            setIsOpen(false)
        });
    }

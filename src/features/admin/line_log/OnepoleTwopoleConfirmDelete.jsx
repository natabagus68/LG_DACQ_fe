...
import { useLine1AsisDestroyMutation } from "../../../app/services/asisService";
import { TrashIcon } from "../../../common/components/icons";

export default function OnepoleTwopoleConfirmDelete({ asisId }) {
    let [isOpen, setIsOpen] = useState(false);
    const [
        _destroyAsis,
        { isLoading: destroyAsisIsLoading, isError: destroyAsisIsError },
    ...
    function destroyAsis(e) {
        e.preventDefault();
        _destroyAsis(asisId)?.then((success) => {
            setIsOpen(false);
        });
    }

        ...
        <>
            <div className="py-[18px] px-[24px] flex justify-between items-center">
                <div className="flex gap-2 items-center">
                    <span>Show</span>
                    <select className="px-2 py-1 bg-white border rounded-lg" value={ perPage } onChange={ e => setPerpage(e.target.value) }>
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <div className="flex items-center border-[1px] border-[#A9A8A8] h-[40px] rounded-[5px] gap-[10px] px-[18px]">
                        ...
                        <input value={ q } onChange={ e => setQ(e.target.value) } type="text" className="bg-transparent outline-none w-[150px] text-[#A4A6A8] font-inter font-normal placeholder:text-[#CACBCD]" placeholder="Search..." />
                    </div>
                </div>
            </div>
                        ...
                        { line1OnepoleTwopoleLogs?.map(item => {
                            return (
                                <Table.Tr className={ `even:bg-[#F8F7FF]` }>
                                    ...
                                    <Table.Td className="whitespace-nowrap py-4 ">{ item?.sn || '-' }</Table.Td>
            ...
            <div className="flex bg-white h-full p-[26px] flex-col font-inter">
                <div className="text-[#A9A8A8] flex items-center justify-between mb-3">
                    <div className='flex items-center gap-1'>
                        ...
                        <span className='text-sm'>/</span>
                        <Link to={`${config.pathPrefix}lines/line-1/onepole-twopole`} className="font-semibold text-sm">One Pole Two Pole</Link>
                        <span className='text-sm'>/</span>

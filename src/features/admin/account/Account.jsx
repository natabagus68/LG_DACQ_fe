        ...
        <>
            <div className="flex bg-white h-full p-[26px] flex-col font-inter">
                <div className="text-[#514E4E] flex font-inter items-center gap-1 mb-3">
                    ...
                    <span className='text-[#A9A8A8] text-sm'>/</span>
                    <span className="font-semibold text-sm text-[#514E4E]">Account</span>
                </div>
                <div className='flex-1'>
                    <div className="w-full h-full flex-col flex border-[1px] border-[#EAEAEA] rounded-lg">
                        <div className="flex items-center justify-between py-[8px] px-[24px] bg-[#F7F9FA] border-b-[1px] border-[#E3E5E6]">
                            <span className="text-[20px] font-semibold text-[#383E49]">Account</span>
                            <div className='flex gap-2'>
                                <div className="flex gap-1 text-white items-center px-[14px] py-[6px] bg-[#667085] h-[32px] rounded-md">
                                    <span>Trash</span>
                                </div>
                                <NavLink to={ 'motor' } className="flex gap-1 text-white items-center px-[14px] py-[6px] bg-[#229BD8] h-[32px] rounded-md">
                                    <PlusIcon />
                                    <span>Add Data</span>
                                </NavLink>
                            </div>
                                ...
                                <table class="flex-1">
                                    ...
                                    <tbody>
                                        <tr class="bg-white border-b">
                                            ...
                                            <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                <div className='flex gap-2'>
                                                    <div className='flex items-center justify-center w-6 h-6 bg-[#2D8DF4] rounded-sm'>
                                                        <EyeIcon />
                                                    </div>
                                                    <div className='flex items-center justify-center w-6 h-6 bg-[#F79009] rounded-sm'>
                                                        <EditIcon />
                                                    </div>
                                                    <div className='flex items-center justify-center w-6 h-6 bg-[#F04438] rounded-sm'>
                                                        <TrashIcon />
                                                    </div>
                                                </div>
                                            </td>

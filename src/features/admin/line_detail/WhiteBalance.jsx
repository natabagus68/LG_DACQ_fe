            ...
            <div className='relative h-full p-[2%] flex font-inter flex-col gap-2 bg-white'>
                <div className="text-[#A9A8A8] flex items-center justify-between mb-3">
                    <div className='flex items-center gap-1'>
                        ...
                        <span className='text-sm'>/</span>
                        <span className="font-semibold text-sm text-[#514E4E]">White Balance</span>
                    </div>
                </div>
                <div className='flex flex-col'>
                    <Card>
                        <div className='flex flex-col flex-1 gap-1'>
                            <div className="flex items-center justify-between">
                                <span className='font-bold text-lg'>White Balance</span>
                        ...
                        <div className='h-[143px]'>
                            <div className='h-full flex gap-[15px]'>
                                <div className='flex-1'>
                                    <Card>
                                        <span className='text-[#2D2A2A] m-auto font-bold'>WB 1</span>
                                        <div className='flex gap-2 justify-between'>
                                            ...
                                            <div className='m-auto'>
                                                ...
                                                <span className='text-[#2D2A2A] m-auto text-center text-[40px] font-bold'>312</span>
                                            </div>
                                        </div>
                                    </Card>
                                </div>
                                <div className='flex-1'>
                                    <Card>
                                        <span className='text-[#2D2A2A] m-auto font-bold'>WB 2</span>
                                        <div className='flex gap-2 justify-between'>
                                            <div className='m-auto'>
                                                <span className='bg-[#B6E9D1] flex-1 px-3 h-[32px] rounded-[12px] flex items-center justify-center text-[#084D2D] text-sm'>Quantity OK</span>
                                                <span className='text-[#2D2A2A] m-auto text-[40px] font-bold'>312</span>
                                ...
                                <div className='flex-1'>
                                    <Card>
                                        <span className='text-[#2D2A2A] m-auto font-bold'>WB 3</span>
                                        <div className='flex gap-2 justify-between'>
                                            <div className='m-auto'>
                                                <span className='bg-[#B6E9D1] flex-1 px-3 h-[32px] rounded-[12px] flex items-center justify-center text-[#084D2D] text-sm'>Quantity OK</span>
                                                <span className='text-[#2D2A2A] m-auto text-[40px] font-bold'>312</span>

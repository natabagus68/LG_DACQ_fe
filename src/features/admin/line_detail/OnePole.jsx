            ...
            <div className='relative h-full p-[2%] flex font-inter flex-col gap-2 bg-white'>
                <div className="text-[#A9A8A8] flex items-center justify-between mb-3">
                    <div className='flex items-center gap-1'>
                        ...
                        <span className='text-sm'>/</span>
                        <span className="font-semibold text-sm text-[#514E4E]">OnePole-TwoPole</span>
                    </div>
                </div>
                <div className='flex flex-col'>
                    <Card>
                        <div className='flex flex-col flex-1 gap-1'>
                            <div className="flex items-center justify-between">
                                <span className='font-bold text-lg'>OnePole-TwoPole</span>
                            ...
                            <div className='h-full flex gap-[15px]'>
                                ...
                                <div className='flex-1'>
                                    <Card>
                                        ...
                                        <span className='text-[#2D2A2A] m-auto text-[40px] font-bold'>37</span>
                                    </Card>
                                </div>
                            </div>
                        </div>
                        ...
                        <Card>
                            ...
                            <div className='flex flex-col gap-4'>
                                <div className='flex gap-[14px] items-center'>
                                    <div className='w-[40px] h-[40px] bg-[#FDDDB3] rounded-full flex items-center justify-center'>
                                        <HiTrendingDown className='w-6 text-[#E18308]' />
                                    </div>
                                    <span className='font-medium'>Panel point 4321 failed detected.</span>
                                </div>
                                <div className='flex gap-[14px] items-center'>
                                    <div className='w-[40px] h-[40px] bg-[#FDDDB3] rounded-full flex items-center justify-center'>
                                        <HiTrendingDown className='w-6 text-[#E18308]' />
                                    </div>
                                    <span className='font-medium'>Panel point 1322 failed detected.</span>
                                </div>
                                <div className='flex gap-[14px] items-center'>
                                    <div className='w-[40px] h-[40px] bg-[#FDDDB3] rounded-full flex items-center justify-center'>
                                        <HiTrendingDown className='w-6 text-[#E18308]' />
                                    </div>
                                    <span className='font-medium'>Panel point 2243 failed detected.</span>
                                </div>
                                <div className='flex gap-[14px] items-center'>
                                    <div className='w-[40px] h-[40px] bg-[#FDDDB3] rounded-full flex items-center justify-center'>
                                        <HiTrendingDown className='w-6 text-[#E18308]' />
                                    </div>
                                    <span className='font-medium'>Panel point 1032 failed detected.</span>
                                </div>
                            </div>
                        </Card>
                    </div>
